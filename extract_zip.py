...
if __name__ == "__main__":
    ...
    parser.add_argument("file_origin_path", help = "specify the path containing the zip file",type=str)
    parser.add_argument("file_destiny_path", help = "specify the path where the zip file must be extracted)",type=str)
